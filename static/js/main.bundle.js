...
/***/ "../../../../../src/app/_guards/default-redirect.guard.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DefaultRedirectGuard; });
...
var DefaultRedirectGuard = (function () {
    function DefaultRedirectGuard(router) {
        this.router = router;
    }
    DefaultRedirectGuard.prototype.canActivate = function (route, state) {
        var user = JSON.parse(localStorage.getItem('helMe'));
        if (user) {
            if ('admin' === user.role) {
    ...
    return DefaultRedirectGuard;
}());
DefaultRedirectGuard = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["C" /* Injectable */])(),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" && _a || Object])
], DefaultRedirectGuard);

var _a;
//# sourceMappingURL=default-redirect.guard.js.map
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "requirementTypeLabels", function() { return __WEBPACK_IMPORTED_MODULE_3__requirement__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "resourceTypeLabels", function() { return __WEBPACK_IMPORTED_MODULE_4__resource__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "userRoleLabels", function() { return __WEBPACK_IMPORTED_MODULE_5__user__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__lists__ = __webpack_require__("../../../../../src/app/_models/lists.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__lists___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__lists__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_authentication_service__ = __webpack_require__("../../../../../src/app/_modules/http/_services/authentication.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AuthGuard = (function () {
    function AuthGuard(router, http, auth) {
        this.router = router;
        this.http = http;
        this.auth = auth;
    }
    AuthGuard.prototype.canActivate = function (route, state) {
        var _this = this;
        return this.auth.isAuthorized().do(function (result) {
            if (!result) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__http_config__ = __webpack_require__("../../../../../src/app/_modules/http/http.config.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AuthenticationService = (function () {
    ...
    AuthenticationService.prototype.login = function (phone, password) {
        var _this = this;
        return this.http.post(__WEBPACK_IMPORTED_MODULE_5__http_config__["b" /* siteUrl */] + 'api-token-auth', { phone: phone, password: password })
            .flatMap(function (response) {
            if (response && response.token) {
                localStorage.setItem('helToken', response.token);
                return _this.http.get(__WEBPACK_IMPORTED_MODULE_5__http_config__["a" /* apiUrl */] + 'user/personal', { headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["c" /* HttpHeaders */]().append('Authorization', 'JWT ' + response.token) }).do(function (user) {
                    localStorage.setItem('helMe', JSON.stringify(user));
                });
            }
    ...
    AuthenticationService.prototype.logout = function () {
        ...
        localStorage.removeItem('helMe');
    };
    AuthenticationService.prototype.isAuthorized = function () {
        var token = localStorage.getItem('helToken');
        if (token) {
            return this.http.post(__WEBPACK_IMPORTED_MODULE_5__http_config__["b" /* siteUrl */] + 'api-token-verify', { token: token })
                .map(function (response) { return true; }).catch(function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_add_observable_empty__ = __webpack_require__("../../../../rxjs/_esm5/add/observable/empty.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__http_config__ = __webpack_require__("../../../../../src/app/_modules/http/http.config.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HttpService = (function () {
    ...
    HttpService.prototype.request = function (method, url, options) {
        return this.http.request(method, __WEBPACK_IMPORTED_MODULE_8__http_config__["a" /* apiUrl */] + url, this.addJwt(options)).catch(this.handleError);
    };
    HttpService.prototype.delete = function (url, options) {
        return this.http.delete(__WEBPACK_IMPORTED_MODULE_8__http_config__["a" /* apiUrl */] + url, this.addJwt(options)).catch(this.handleError);
    };
    HttpService.prototype.get = function (url, options) {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_8__http_config__["a" /* apiUrl */] + url, this.addJwt(options)).catch(this.handleError);
    };
    HttpService.prototype.post = function (url, body, options) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_8__http_config__["a" /* apiUrl */] + url, body, this.addJwt(options)).catch(this.handleError);
    };
    HttpService.prototype.put = function (url, body, options) {
        return this.http.put(__WEBPACK_IMPORTED_MODULE_8__http_config__["a" /* apiUrl */] + url, body, this.addJwt(options)).catch(this.handleError);
    };
...
/***/ "../../../../../src/app/_modules/project-editor/_guards/_index.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__project_editor_access_guard__ = __webpack_require__("../../../../../src/app/_modules/project-editor/_guards/project-editor-access.guard.ts");
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__project_editor_access_guard__["a"]; });

//# sourceMappingURL=_index.js.map

/***/ }),

/***/ "../../../../../src/app/_modules/project-editor/_guards/project-editor-access.guard.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProjectEditorAccessGuard; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var ProjectEditorAccessGuard = (function () {
    function ProjectEditorAccessGuard(router) {
        this.router = router;
    }
    ProjectEditorAccessGuard.prototype.canActivate = function (route, state) {
        var user = JSON.parse(localStorage.getItem('helMe'));
    ...
    return ProjectEditorAccessGuard;
}());
ProjectEditorAccessGuard = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["C" /* Injectable */])(),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" && _a || Object])
], ProjectEditorAccessGuard);

var _a;
//# sourceMappingURL=project-editor-access.guard.js.map

/***/ }),

/***/ "../../../../../src/app/_modules/project-editor/_services/_index.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__project_editor_service__ = __webpack_require__("../../../../../src/app/_modules/project-editor/_services/project-editor.service.ts");
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__project_editor_service__["a"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_http_guards_auth_guard__ = __webpack_require__("../../../../../src/app/_modules/http/_guards/auth.guard.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__project_editor_project_editor_component__ = __webpack_require__("../../../../../src/app/_modules/project-editor/project-editor/project-editor.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__project_list_project_list_component__ = __webpack_require__("../../../../../src/app/_modules/project-editor/project-list/project-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__guards_index__ = __webpack_require__("../../../../../src/app/_modules/project-editor/_guards/_index.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: 'editor',
        canActivate: [__WEBPACK_IMPORTED_MODULE_2__modules_http_guards_auth_guard__["a" /* AuthGuard */], __WEBPACK_IMPORTED_MODULE_5__guards_index__["a" /* ProjectEditorAccessGuard */]],
        children: [
            {
                path: '',
                pathMatch: 'full',
                component: __WEBPACK_IMPORTED_MODULE_4__project_list_project_list_component__["a" /* ProjectListComponent */],
            },
            {
                path: ':id',
                component: __WEBPACK_IMPORTED_MODULE_3__project_editor_project_editor_component__["a" /* ProjectEditorComponent */],
            }
        ]
    },
];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__guards_index__ = __webpack_require__("../../../../../src/app/_modules/project-editor/_guards/_index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__project_list_project_list_component__ = __webpack_require__("../../../../../src/app/_modules/project-editor/project-list/project-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__project_list_project_label_dialog_component__ = __webpack_require__("../../../../../src/app/_modules/project-editor/project-list/project-label-dialog.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__project_editor_project_editor_component__ = __webpack_require__("../../../../../src/app/_modules/project-editor/project-editor/project-editor.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__project_editor_container_label_dialog_component__ = __webpack_require__("../../../../../src/app/_modules/project-editor/project-editor/container-label-dialog.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__project_editor_field_options_dialog_component__ = __webpack_require__("../../../../../src/app/_modules/project-editor/project-editor/field-options-dialog.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__project_editor_confirm_delete_dialog_component__ = __webpack_require__("../../../../../src/app/_modules/project-editor/project-editor/confirm-delete-dialog.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
ProjectEditorModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgModule */])({
        ...
        declarations: [
            __WEBPACK_IMPORTED_MODULE_8__project_list_project_list_component__["a" /* ProjectListComponent */],
            __WEBPACK_IMPORTED_MODULE_9__project_list_project_label_dialog_component__["a" /* ProjectLabelDialogComponent */],
            __WEBPACK_IMPORTED_MODULE_10__project_editor_project_editor_component__["a" /* ProjectEditorComponent */],
            __WEBPACK_IMPORTED_MODULE_11__project_editor_container_label_dialog_component__["a" /* ContainerLabelDialogComponent */],
            __WEBPACK_IMPORTED_MODULE_12__project_editor_field_options_dialog_component__["a" /* FieldOptionsDialogComponent */],
            __WEBPACK_IMPORTED_MODULE_13__project_editor_confirm_delete_dialog_component__["a" /* ConfirmDeleteDialogComponent */],
        ],
        entryComponents: [
            __WEBPACK_IMPORTED_MODULE_9__project_list_project_label_dialog_component__["a" /* ProjectLabelDialogComponent */],
            __WEBPACK_IMPORTED_MODULE_11__project_editor_container_label_dialog_component__["a" /* ContainerLabelDialogComponent */],
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_7__guards_index__["a" /* ProjectEditorAccessGuard */],
        ]
    })
], ProjectEditorModule);
...
var ProjectEditorComponent = (function () {
    function ProjectEditorComponent(editor, dialog, route, router) {
        ...
        this.route = route;
        this.router = router;
        this.resourceTypeLabels = __WEBPACK_IMPORTED_MODULE_4__models_index__["resourceTypeLabels"];
        this.requirementTypeLabels = __WEBPACK_IMPORTED_MODULE_4__models_index__["requirementTypeLabels"];
    }
    // For debugging
    ...
    ProjectEditorComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.userRoleList = [];
        for (var _i = 0, _a = Object.keys(__WEBPACK_IMPORTED_MODULE_4__models_index__["userRoleLabels"]); _i < _a.length; _i++) {
            var value = _a[_i];
            this.userRoleList.push({ value: value, label: __WEBPACK_IMPORTED_MODULE_4__models_index__["userRoleLabels"][value] });
        }
        this.resourceTypeList = [];
        for (var _b = 0, _c = Object.keys(__WEBPACK_IMPORTED_MODULE_4__models_index__["resourceTypeLabels"]); _b < _c.length; _b++) {
            var value = _c[_b];
            this.resourceTypeList.push({ value: value, label: __WEBPACK_IMPORTED_MODULE_4__models_index__["resourceTypeLabels"][value] });
        }
        this.requirementTypeList = [];
        for (var _d = 0, _e = Object.keys(__WEBPACK_IMPORTED_MODULE_4__models_index__["requirementTypeLabels"]); _d < _e.length; _d++) {
            var value = _e[_d];
            this.requirementTypeList.push({ value: value, label: __WEBPACK_IMPORTED_MODULE_4__models_index__["requirementTypeLabels"][value] });
        }
    ...
    ProjectEditorComponent.prototype.deleteStageDialog = function (tag, label) {
        ...
        dialog.afterClosed().subscribe(function (data) {
            if (undefined !== data && 'string' !== typeof data) {
                ...
                _this.selectStage = undefined;
                _this.selectDesk = undefined;
                _this.selectCard = undefined;
            }
        });
    };
...
/***/ "../../../../../src/app/_modules/project-manager/_guards/_index.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__project_manager_access_guard__ = __webpack_require__("../../../../../src/app/_modules/project-manager/_guards/project-manager-access.guard.ts");
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__project_manager_access_guard__["a"]; });

//# sourceMappingURL=_index.js.map

/***/ }),

/***/ "../../../../../src/app/_modules/project-manager/_guards/project-manager-access.guard.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProjectManagerAccessGuard; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var ProjectManagerAccessGuard = (function () {
    function ProjectManagerAccessGuard(router) {
        this.router = router;
    }
    ProjectManagerAccessGuard.prototype.canActivate = function (route, state) {
        var user = JSON.parse(localStorage.getItem('helMe'));
        if (user && 'admin' !== user.role) {
            return true;
        }
    ...
    return ProjectManagerAccessGuard;
}());
ProjectManagerAccessGuard = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["C" /* Injectable */])(),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" && _a || Object])
], ProjectManagerAccessGuard);

var _a;
//# sourceMappingURL=project-manager-access.guard.js.map

/***/ }),

/***/ "../../../../../src/app/_modules/project-manager/_services/_index.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__project_manager_service__ = __webpack_require__("../../../../../src/app/_modules/project-manager/_services/project-manager.service.ts");
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__project_manager_service__["a"]; });

//# sourceMappingURL=_index.js.map

/***/ }),

/***/ "../../../../../src/app/_modules/project-manager/_services/project-manager.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProjectManagerService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__http_services_http_service__ = __webpack_require__("../../../../../src/app/_modules/http/_services/http.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_common_http__ = __webpack_require__("../../../common/@angular/common/http.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var ProjectManagerService = (function () {
    function ProjectManagerService(http) {
        this.http = http;
    }
    ProjectManagerService.prototype.createProject = function (label, template_id) {
        return this.http.post('project/create', { label: label, template_id: template_id });
    };
    ProjectManagerService.prototype.listProjects = function () {
        return this.http.get('project/list');
    };
    ProjectManagerService.prototype.getProject = function (id) {
        return this.http.get('project/get', { params: new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpParams */]().append('id', id.toString()) });
    };
    ProjectManagerService.prototype.getContainer = function (tag, project_id) {
        return this.http.get('container/get', { params: new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpParams */]().append('tag', tag).append('project_id', project_id.toString()) });
    };
    ProjectManagerService.prototype.getCard = function (tag, project_id) {
        return this.http.get('work/get', { params: new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpParams */]().append('tag', tag).append('project_id', project_id.toString()) }).map(function (work) {
            var card = work;
    ...
    ProjectManagerService.prototype.startWork = function (tag, project_id) {
        return this.http.get('work/start', { params: new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpParams */]().append('tag', tag).append('project_id', project_id.toString()) }).map(function (response) { return response.status; });
    };
    ProjectManagerService.prototype.completeWork = function (tag, project_id) {
        return this.http.get('work/complete', { params: new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpParams */]().append('tag', tag).append('project_id', project_id.toString()) }).map(function (response) { return response.status; });
    };
    ProjectManagerService.prototype.verifyWork = function (tag, project_id) {
        return this.http.get('work/verify', { params: new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpParams */]().append('tag', tag).append('project_id', project_id.toString()) }).map(function (response) { return response.status; });
    };
    ProjectManagerService.prototype.denyWork = function (tag, project_id) {
        return this.http.get('work/deny', { params: new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpParams */]().append('tag', tag).append('project_id', project_id.toString()) }).map(function (response) { return response.status; });
    };
    ProjectManagerService.prototype.postMessage = function (tag, project_id, text) {
        return this.http.post('work/post_message', { text: text, files: '' }, { params: new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpParams */]().append('tag', tag).append('project_id', project_id.toString()) });
    };
    ProjectManagerService.prototype.getResource = function (tag, project_id) {
        return this.http.get('resource/get', { params: new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpParams */]().append('tag', tag).append('project_id', project_id.toString()) });
    };
    ProjectManagerService.prototype.updateResource = function (tag, project_id) {
        return this.http.get('resource/get', { params: new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpParams */]().append('tag', tag).append('project_id', project_id.toString()) });
    };
    ProjectManagerService.prototype.getUser = function (id) {
        return this.http.get('user/get', { params: new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpParams */]().append('id', id.toString()) });
    };
    return ProjectManagerService;
}());
ProjectManagerService = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["C" /* Injectable */])(),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__http_services_http_service__["a" /* HttpService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__http_services_http_service__["a" /* HttpService */]) === "function" && _a || Object])
...
module.exports = "<div class=\"row\">\n  <div class=\"col-3\" *ngFor=\"let card of list\">\n    <mat-card [routerLink]=\"['../../', card.tag]\">\n      {{card.label}}\n    </mat-card>\n  </div>\n</div>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_index__ = __webpack_require__("../../../../../src/app/_modules/project-manager/_services/_index.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CardListComponent = (function () {
    function CardListComponent(router, route, manager) {
        this.router = router;
        this.route = route;
    ...
    CardListComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (params) {
            ...
            _this.manager.getContainer(tag, id).subscribe(function (desk) {
                for (var _i = 0, _a = desk.children; _i < _a.length; _i++) {
                    var card_tag = _a[_i];
                    _this.manager.getCard(card_tag, id).subscribe(function (card) {
                        _this.list.push({ tag: card.tag, label: card.label });
                    });
                }
            }, function (error) {
            });
...
CardListComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__services_index__["a" /* ProjectManagerService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_index__["a" /* ProjectManagerService */]) === "function" && _c || Object])
], CardListComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_project_manager_service__ = __webpack_require__("../../../../../src/app/_modules/project-manager/_services/project-manager.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CardComponent = (function () {
    function CardComponent(router, route, manager) {
        this.router = router;
        this.route = route;
        this.manager = manager;
        this.canStartWorking = false;
        this.canComplete = false;
        this.canVerify = false;
    }
    CardComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.user = JSON.parse(localStorage.getItem('helMe'));
        this.route.paramMap.subscribe(function (params) {
            var id = +params.get('id');
            var tag = params.get('tag');
            _this.manager.getCard(tag, id).subscribe(function (card) {
                _this.card = card;
                _this.loadUsers();
                _this.setActions();
            });
    ...
    CardComponent.prototype.loadUsers = function () {
        var _this = this;
        if (this.card.executor) {
            this.manager.getUser(this.card.executor).subscribe(function (user) {
                _this.executor = user;
            });
        }
        if (this.card.verifier) {
            this.manager.getUser(this.card.verifier).subscribe(function (user) {
                _this.verifier = user;
            });
        }
    };
    CardComponent.prototype.setActions = function () {
        if (this.card.executor === this.user.id) {
            if ('aw' === this.card.status[0]) {
                this.canStartWorking = true;
            }
            else if ('ip' === this.card.status[0]) {
                this.canComplete = true;
            }
        }
        else if (this.card.verifier === this.user.id
            && 'av' === this.card.status[0]) {
            this.canVerify = true;
        }
    };
    CardComponent.prototype.postMessage = function (message) {
        this.manager.postMessage(this.card.tag, this.card.project_id, message)
            .subscribe(function (response) {
        });
    };
    CardComponent.prototype.startWorking = function () {
        var _this = this;
        this.manager.startWork(this.card.tag, this.card.project_id)
            .subscribe(function (status) {
            _this.card.status = status;
            _this.setActions();
        });
    };
    CardComponent.prototype.complete = function () {
        var _this = this;
        this.manager.completeWork(this.card.tag, this.card.project_id)
            .subscribe(function (status) {
            _this.card.status = status;
            _this.setActions();
        });
    };
    CardComponent.prototype.verify = function () {
        var _this = this;
        this.manager.verifyWork(this.card.tag, this.card.project_id)
            .subscribe(function (status) {
            _this.card.status = status;
            _this.setActions();
        });
    };
    CardComponent.prototype.deny = function () {
        var _this = this;
        this.manager.denyWork(this.card.tag, this.card.project_id)
            .subscribe(function (status) {
            _this.card.status = status;
            _this.setActions();
        });
...
CardComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__services_project_manager_service__["a" /* ProjectManagerService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_project_manager_service__["a" /* ProjectManagerService */]) === "function" && _c || Object])
], CardComponent);
...
/***/ "../../../../../src/app/_modules/project-manager/project-list/create-project-dialog.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CreateProjectDialogComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_material__ = __webpack_require__("../../../material/esm5/material.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__project_editor_services_index__ = __webpack_require__("../../../../../src/app/_modules/project-editor/_services/_index.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CreateProjectDialogComponent = (function () {
    function CreateProjectDialogComponent(dialogRef, editor) {
        this.dialogRef = dialogRef;
        this.editor = editor;
    }
    CreateProjectDialogComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.editor.listProjects().subscribe(function (response) {
            _this.templates = response;
        });
    };
    CreateProjectDialogComponent.prototype.confirm = function () {
        if (!this.label.empty && !this.template_id.empty) {
            this.dialogRef.close({ label: this.label.value, template_id: this.template_id.value });
        }
    };
    return CreateProjectDialogComponent;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_16" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_1__angular_material__["k" /* MatInput */]),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_material__["k" /* MatInput */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_material__["k" /* MatInput */]) === "function" && _a || Object)
], CreateProjectDialogComponent.prototype, "label", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_16" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_1__angular_material__["q" /* MatSelect */]),
    __metadata("design:type", typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_material__["q" /* MatSelect */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_material__["q" /* MatSelect */]) === "function" && _b || Object)
], CreateProjectDialogComponent.prototype, "template_id", void 0);
CreateProjectDialogComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        selector: 'pe-create-project-dialog',
        template: "\n  <mat-dialog-content>\n  <form class=\"full-width\">\n    <mat-form-field class=\"full-width\">\n      <input matInput placeholder=\"\u0418\u043C\u044F \u043F\u0440\u043E\u0435\u043A\u0442\u0430\">\n    </mat-form-field>\n      <mat-select placeholder=\"\u0428\u0430\u0431\u043B\u043E\u043D\">\n        <mat-option *ngFor=\"let template of templates\" [value]=\"template.id\">\n          {{template.label}}\n        </mat-option>\n      </mat-select>\n  </form>\n  </mat-dialog-content>\n  <mat-dialog-actions>\n    <button mat-button (click)=\"confirm()\">\u0421\u043E\u0437\u0434\u0430\u0442\u044C</button>\n    <button mat-button mat-dialog-close>\u041E\u0442\u043C\u0435\u043D\u0438\u0442\u044C</button>\n  </mat-dialog-actions>\n  ",
        providers: [
            __WEBPACK_IMPORTED_MODULE_2__project_editor_services_index__["a" /* ProjectEditorService */],
        ]
    }),
    __metadata("design:paramtypes", [typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__angular_material__["h" /* MatDialogRef */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_material__["h" /* MatDialogRef */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__project_editor_services_index__["a" /* ProjectEditorService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__project_editor_services_index__["a" /* ProjectEditorService */]) === "function" && _d || Object])
], CreateProjectDialogComponent);

var _a, _b, _c, _d;
//# sourceMappingURL=create-project-dialog.component.js.map
...
module.exports = "<mat-nav-list>\n  <mat-list-item *ngFor=\"let project of list\" [routerLink]=\"[project.id, 'stages']\">\n    {{project.label}}\n  </mat-list-item>\n</mat-nav-list>\n<span class=\"d-flex justify-content-center mt-4\"\n  *ngIf=\"'project_manager' == user.role\">\n  <button mat-mini-fab color=\"accent\" (click)=\"createNew()\"><mat-icon>add</mat-icon></button>\n</span>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_material__ = __webpack_require__("../../../material/esm5/material.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_index__ = __webpack_require__("../../../../../src/app/_modules/project-manager/_services/_index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__create_project_dialog_component__ = __webpack_require__("../../../../../src/app/_modules/project-manager/project-list/create-project-dialog.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProjectListComponent = (function () {
    function ProjectListComponent(manager, dialog, router) {
        this.manager = manager;
        this.dialog = dialog;
        this.router = router;
    }
    ProjectListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.user = JSON.parse(localStorage.getItem('helMe'));
        this.manager.listProjects().subscribe(function (list) {
            _this.list = list;
        });
    };
    ProjectListComponent.prototype.createNew = function () {
        var _this = this;
        var dialog = this.dialog.open(__WEBPACK_IMPORTED_MODULE_4__create_project_dialog_component__["a" /* CreateProjectDialogComponent */], {
            width: '400px',
        });
        dialog.afterClosed().subscribe(function (data) {
            if ('string' !== typeof data) {
                _this.manager.createProject(data.label, data.template_id).subscribe(function (response) {
                    var id = response.id;
                    _this.router.navigate(['manager', id, 'stages']);
                });
            }
        });
    };
...
ProjectListComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3__services_index__["a" /* ProjectManagerService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_index__["a" /* ProjectManagerService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__angular_material__["f" /* MatDialog */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_material__["f" /* MatDialog */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" && _c || Object])
], ProjectListComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__http_guards_index__ = __webpack_require__("../../../../../src/app/_modules/http/_guards/_index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__project_manager_project_manager_component__ = __webpack_require__("../../../../../src/app/_modules/project-manager/project-manager/project-manager.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__project_list_project_list_component__ = __webpack_require__("../../../../../src/app/_modules/project-manager/project-list/project-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__stage_list_stage_list_component__ = __webpack_require__("../../../../../src/app/_modules/project-manager/stage-list/stage-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__card_list_card_list_component__ = __webpack_require__("../../../../../src/app/_modules/project-manager/card-list/card-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__card_card_component__ = __webpack_require__("../../../../../src/app/_modules/project-manager/card/card.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__guards_index__ = __webpack_require__("../../../../../src/app/_modules/project-manager/_guards/_index.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: 'manager',
        canActivate: [__WEBPACK_IMPORTED_MODULE_2__http_guards_index__["a" /* AuthGuard */], __WEBPACK_IMPORTED_MODULE_8__guards_index__["a" /* ProjectManagerAccessGuard */]],
        component: __WEBPACK_IMPORTED_MODULE_3__project_manager_project_manager_component__["a" /* ProjectManagerComponent */],
        children: [
            { path: '', pathMatch: 'full', component: __WEBPACK_IMPORTED_MODULE_4__project_list_project_list_component__["a" /* ProjectListComponent */] },
            {
                path: ':id',
                children: [
                    { path: 'stages', pathMatch: 'full', component: __WEBPACK_IMPORTED_MODULE_5__stage_list_stage_list_component__["a" /* StageListComponent */] },
                    { path: ':tag/cards', pathMatch: 'full', component: __WEBPACK_IMPORTED_MODULE_6__card_list_card_list_component__["a" /* CardListComponent */] },
                    { path: ':tag', pathMatch: 'full', component: __WEBPACK_IMPORTED_MODULE_7__card_card_component__["a" /* CardComponent */] },
                ],
            },
        ],
    },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__http_http_module__ = __webpack_require__("../../../../../src/app/_modules/http/http.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__project_manager_routing_module__ = __webpack_require__("../../../../../src/app/_modules/project-manager/project-manager-routing.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_index__ = __webpack_require__("../../../../../src/app/_modules/project-manager/_services/_index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__guards_index__ = __webpack_require__("../../../../../src/app/_modules/project-manager/_guards/_index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__project_manager_project_manager_component__ = __webpack_require__("../../../../../src/app/_modules/project-manager/project-manager/project-manager.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__project_list_project_list_component__ = __webpack_require__("../../../../../src/app/_modules/project-manager/project-list/project-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__project_list_create_project_dialog_component__ = __webpack_require__("../../../../../src/app/_modules/project-manager/project-list/create-project-dialog.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__stage_list_stage_list_component__ = __webpack_require__("../../../../../src/app/_modules/project-manager/stage-list/stage-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__card_list_card_list_component__ = __webpack_require__("../../../../../src/app/_modules/project-manager/card-list/card-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__card_card_component__ = __webpack_require__("../../../../../src/app/_modules/project-manager/card/card.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__chat_chat_component__ = __webpack_require__("../../../../../src/app/_modules/project-manager/chat/chat.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
ProjectManagerModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgModule */])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_3__http_http_module__["a" /* HttpModule */],
            __WEBPACK_IMPORTED_MODULE_4__project_manager_routing_module__["a" /* ProjectManagerRoutingModule */],
        ],
        declarations: [
            __WEBPACK_IMPORTED_MODULE_7__project_manager_project_manager_component__["a" /* ProjectManagerComponent */],
            __WEBPACK_IMPORTED_MODULE_8__project_list_project_list_component__["a" /* ProjectListComponent */],
            __WEBPACK_IMPORTED_MODULE_9__project_list_create_project_dialog_component__["a" /* CreateProjectDialogComponent */],
            __WEBPACK_IMPORTED_MODULE_10__stage_list_stage_list_component__["a" /* StageListComponent */],
            __WEBPACK_IMPORTED_MODULE_11__card_list_card_list_component__["a" /* CardListComponent */],
            ...
            __WEBPACK_IMPORTED_MODULE_13__chat_chat_component__["c" /* ChatMessageComponent */],
            __WEBPACK_IMPORTED_MODULE_13__chat_chat_component__["b" /* ChatMessageAuthorComponent */],
            __WEBPACK_IMPORTED_MODULE_13__chat_chat_component__["d" /* ChatMessageContentComponent */],
        ],
        entryComponents: [
            __WEBPACK_IMPORTED_MODULE_9__project_list_create_project_dialog_component__["a" /* CreateProjectDialogComponent */],
        ],
        providers: [
            __WEBPACK_IMPORTED_MODULE_5__services_index__["a" /* ProjectManagerService */],
            __WEBPACK_IMPORTED_MODULE_6__guards_index__["a" /* ProjectManagerAccessGuard */],
        ],
    })
...
module.exports = "<div class=\"container-fluid full-height d-flex-column my-3\">\n  <router-outlet class=\"flex-stretch\"></router-outlet>\n</div>\n"
...
module.exports = "<div class=\"row\">\n  <div class=\"col-3\" *ngFor=\"let stage of list\">\n    <mat-card>\n      <mat-card-title>{{stage.label}}</mat-card-title>\n      <mat-nav-list>\n        <mat-divider></mat-divider>\n        <mat-list-item *ngFor=\"let desk_tag of stage.children\"\n          [routerLink]=\"['../', desks[desk_tag]?.tag, 'cards']\">\n          {{desks[desk_tag]?.label}}\n        </mat-list-item>\n      </mat-nav-list>\n    </mat-card>\n  </div>\n</div>\n"
...
var StageListComponent = (function () {
    function StageListComponent(router, route, manager) {
        this.router = router;
        this.route = route;
        this.manager = manager;
        this.list = [];
    ...
    StageListComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (params) {
            var id = +params.get('id');
            var tag = params.get('tag');
            _this.manager.getProject(id).subscribe(function (response) {
                var stage_tags = response.children;
                for (var _i = 0, stage_tags_1 = stage_tags; _i < stage_tags_1.length; _i++) {
                    var stage_tag = stage_tags_1[_i];
                    _this.manager.getContainer(stage_tag, id).subscribe(function (stage) {
                        _this.list.push(stage);
                        var _loop_1 = function (desk_tag) {
                            _this.manager.getContainer(desk_tag, id).subscribe(function (desk) {
                                desk.tag = desk_tag;
                                _this.desks[desk_tag] = desk;
                            });
                        };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__guards_default_redirect_guard__ = __webpack_require__("../../../../../src/app/_guards/default-redirect.guard.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var appRoutes = [
    {
        path: '',
        canActivate: [__WEBPACK_IMPORTED_MODULE_5__guards_default_redirect_guard__["a" /* DefaultRedirectGuard */]],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__guards_default_redirect_guard__ = __webpack_require__("../../../../../src/app/_guards/default-redirect.guard.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgModule */])({
        ...
        providers: [
            __WEBPACK_IMPORTED_MODULE_13__guards_default_redirect_guard__["a" /* DefaultRedirectGuard */],
        ],
        bootstrap: [
            __WEBPACK_IMPORTED_MODULE_9__app_component__["a" /* AppComponent */]
        ]
